...
console.log(nombres);
var mascotas = ['Perro', 'Gato', 'Tortuga', 'Gallina', 'Gallina'];
...
var mascotasFiltradas = mascotas.filter(function (mascota) { return mascota === 'Gallina'; });
...
var productosCaros = productos.filter(function (producto) { return producto.precio === 150; });
console.log('Productos caros filtratos');
console.log(productosCaros);
var productosDeEnsenada1 = productos.filter(function (producto) { return producto.direccion.codigoPostal === 22855; });
console.log('Productos por codigo postal');
console.log(productosDeEnsenada1);
var productosDeEnsenada2 = productos.filter(function (producto) {
...
var productoDeRosarito = productos.find(function (producto) { return producto.direccion.ciudad === 'Rosarito'; });
...
var indice = productos.findIndex(function (producto) { return producto.direccion.ciudad === 'Rosarito'; });
if (indice !== -1) {
...
var nombresPersonas = personas4.map(function (persona) {
...
var productosConvertidos = productosDummy.products.map(function (pruducto) {
    return {};
});
